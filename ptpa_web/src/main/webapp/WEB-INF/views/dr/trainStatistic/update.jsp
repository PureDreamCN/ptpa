                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="cc" name="cc" type="text"
                               ...
                               value="${list[0].cc}" maxlength="20"> <label id=""></label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="ddjmc" type="text" name="ddjmc"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].ddjmc}" maxlength="40"><label id="codeTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="lineCode" type="text" name="lineCode"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].lineCode}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="beginEnd" type="text" name="beginEnd"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].beginEnd}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="mileage" type="text" name="mileage"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].mileage}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="railwayName" type="text" name="railwayName"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].railwayName}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="railwayLevel" type="text" name="railwayLevel"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].railwayLevel}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="railwaySsjmc" type="text" name="railwaySsjmc"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].railwaySsjmc}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="locomotiveType" type="text" name="locomotiveType"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].locomotiveType}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="locomotivePsjmc" type="text" name="locomotivePsjmc"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].locomotivePsjmc}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="trainMileage" type="text" name="trainMileage"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].trainMileage}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="trainVehicleMileageSum" type="text" name="trainVehicleMileageSum"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].trainVehicleMileageSum}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>

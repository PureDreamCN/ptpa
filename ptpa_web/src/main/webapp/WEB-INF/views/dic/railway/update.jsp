    ...
    <div class="col-md-8">
        <form role="form" id="resouceForm" name="resouceForm"
            ...
            <div class="form-body">
                ...
                <input type="hidden" name="oldXldm" value="${railway.xldm}">
                <div class="form-group">
                    <label class="col-md-3 control-label">线路代码：</label>
                    <div class="col-md-9">
                        <input  name="xldm" type="text" id="xldm"
                               class="form-control input-inline  input-xlarge" placeholder="输入长度限制为20个字符"
                               value="${railway.xldm}" maxlength="20"> <label id="xldmTip"></label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input  type="text" name="name" id="name"
                               ...
                               value="${railway.name}" maxlength="15"><label id="nameTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input  type="text" name="beginCzdm" id="beginCzdm"
                               ...
                               value="${railway.beginCzdm}" maxlength="10"><label id="beginCzdmTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="endCzdm"  id="endCzdm"
                               class="form-control input-inline  input-xlarge" placeholder="输入长度限制为10个字符"
                               value="${railway.endCzdm}" maxlength="10"><label id="endCzdmTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input  type="text" name="mileage" id="mileage"
                               ...
                               value="${railway.mileage}" maxlength="6"><label id="mileageTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="propertyRight" id="propertyRight"
                               class="form-control input-inline  input-xlarge" placeholder="输入长度限制为10个字符"
                               value="${railway.propertyRight}" maxlength="10"><label id="propertyRightTip"></label>
                    </div>
                </div>

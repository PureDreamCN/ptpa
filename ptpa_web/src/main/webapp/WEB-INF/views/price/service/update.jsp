...
<div class="row">
    <div class="col-md-12">
        <form role="form" id="priceServiceForm" name="priceServiceForm" class="form-horizontal"
            ...
            <input type="hidden" name="id" value="${priceService.id }">
            <div class="form-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <form:select path="priceService.serviceCode"
				         ...
				         <input type="hidden" id="serviceName" name="serviceName" value="${priceService.serviceName }"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="unit" maxlength="20" name="unit" type="text" class="form-control input-inline  input-xlarge"
                               placeholder=""
                               value="${priceService.unit }"> <label id="unitTip"></label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input id="price" maxlength="13" name="price" type="text" class="form-control input-inline  input-xlarge"
                               placeholder=""
                               value="${priceService.price }"> <label id="priceTip"></label>
                    </div>
                </div>
            </div>

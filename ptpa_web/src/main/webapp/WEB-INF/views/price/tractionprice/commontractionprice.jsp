                ...
                <tr>
                    <td>
                        <label class="mt-checkbox mt-checkbox-outline">
                            <input name="module" type="radio" value="${tractionPrice.id}" class="father">
                            <span></span>
                        </label>
                    </td>
                    <td>${tractionPrice.ljdm } </td>
...
<critc-script>
    ...
    <script type="text/javascript">
        ...
        // 查询方法
        var search = function () {
            var url = "commonTractionPrice.htm?";
            if ($("#cmbljdm").val() != '')
        ...
        var confirm = function (id) {
            ...
            if (id) {
                window.location = "${dynamicServer}/train/tractionpricedate.htm?trainId=${trainId}&lineId=${lineId}&dataId=" + id + "&param=2";
            }else{

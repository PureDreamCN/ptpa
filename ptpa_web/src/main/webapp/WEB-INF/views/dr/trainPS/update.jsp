                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="jlCode" name="jlCode" type="text"
                               ...
                               value="${list[0].jlCode}" maxlength="20"> <label id=""></label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="statisticDate" type="text" name="statisticDate"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="<fmt:formatDate value='${list[0].statisticDate }' pattern='yyyy-MM-dd ' />" maxlength="40"><label id="codeTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="cc" type="text" name="cc"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].cc}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="passengerVolume" type="text" name="passengerVolume"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].passengerVolume}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="passengerMileage" type="text" name="passengerMileage"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].passengerMileage}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="fareSum" type="text" name="fareSum"
                               class="form-control input-inline  input-xlarge" placeholder=""
                               value="${list[0].fareSum}" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
